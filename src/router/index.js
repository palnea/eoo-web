...
import ExternalSignUpOkyanus from "@/pages/External/ExternalSignUpOkyanus.vue";
...
const router = createRouter({
  ...
  routes: [
    ...
    {
      path: '/external-signup-okyanus',
      name: 'external-signup-okyanus',
      component: ExternalSignUpOkyanus
    },
    {
      path: '/r',
